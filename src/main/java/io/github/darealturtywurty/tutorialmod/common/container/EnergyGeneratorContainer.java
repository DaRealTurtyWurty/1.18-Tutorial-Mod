...
import io.github.darealturtywurty.tutorialmod.common.container.syncdata.EnergyGeneratorContainerData;
...
public class EnergyGeneratorContainer extends AbstractContainerMenu {
    ...
    public EnergyGeneratorContainer(int id, Inventory playerInv, IItemHandler slots, BlockPos pos, ContainerData data) {
        super(ContainerInit.ENERGY_GENERATOR.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.containerAccess, player, BlockInit.ENERGY_GENERATOR.get());
    }
