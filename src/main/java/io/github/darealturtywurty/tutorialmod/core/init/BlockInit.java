...
import io.github.darealturtywurty.tutorialmod.common.block.BaseCropBlock;
...
public final class BlockInit {
    ...
    public static final RegistryObject<Block> EXAMPLE_BLOCK = BLOCKS.register("example_block",
        () -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_BLUE).strength(2.0f, 15f)
    ...
    public static final RegistryObject<BaseCropBlock> CROPIUM = BLOCKS.register("cropium",
        () -> new BaseCropBlock(ItemInit.CROPIUM, BlockBehaviour.Properties.copy(Blocks.WHEAT)));
